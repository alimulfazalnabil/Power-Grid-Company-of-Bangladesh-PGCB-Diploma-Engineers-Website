  ...
  return (
    <main className="min-h-screen bg-slate-100 p-6 text-slate-900 md:p-10">
      <div className="mx-auto max-w-3xl rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
        ...
        <h1 className="mt-3 text-3xl font-semibold">Edit slide</h1>
        <p className="mt-3 text-slate-600">This route will host the slider editing form in the next CMS iteration.</p>
